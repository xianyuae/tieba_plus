...
QtObject {
    ...
    property int _iHeaderHeight: 68;
    ...
    property int _iSizeSuper: 320;
		...
		property color _cLightestColor: !_bInverted ? "#ffffff" : "#212226";
		property color _cLighterColor: !_bInverted ? "#f2f3f5" : "#2a2b31";
		property color _cLightColor: !_bInverted ? "#dfe2e8" : "#3a3c44";
		property color _cDarkColor: !_bInverted ? "#878c96" : "#9096a1";
		property color _cDarkerColor: !_bInverted ? "#22262c" : "#e7e9ed";
		property color _cDarkestColor: !_bInverted ? "#14161a" : "#f6f7f9";
		...
		property color _cNightColor: "#17181c";

		property color _cBgColor: _bInverted ? "#141518" : "#f5f6f8";
		property color _cCardColor: _bInverted ? "#222329" : "#ffffff";
		property color _cSurfaceColor: _bInverted ? "#26272d" : "#ffffff";
		property color _cDividerColor: _bInverted ? "#373940" : "#e6e8ec";
		property color _cTextPrimary: _cDarkerColor;
		property color _cTextSecondary: _cDarkColor;
		property color _cTextHint: _cLightColor;
		property color _cOverlayColor: "#66000000";
		property color _cOverlayLightColor: "#55ffffff";
		property color _cBadgeBg: _bInverted ? "#00000088" : "#cc000000";

		property int _iRadiusSmall: 4;
		property int _iRadiusMedium: 8;
		property int _iRadiusLarge: 12;
		property int _iNavHeight: 64;
		property int _iCardPadding: 10;
		property int _iPageMargin: 12;
