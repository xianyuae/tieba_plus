...
#define ID_APP "PPSH"
#define ID_NAME QObject::tr("Pili Player")
#define ID_PKG "ppsh"
#define ID_VER "1.1"
#define ID_CODE "natasha"
#define ID_DEV "karin"
#define ID_RELEASE "2026.8.6"
#define ID_PATCH "1"
...
#define ID_DESC QObject::tr("Pili Player is a simple web-video player for Bilibili, based on Web-API.")
#define ID_BUID "14345912"
#define ID_COPYRIGHT "Copyright (C) 2014 karin <beyondk2000@gmail.com>"
#define ID_LICENSE QObject::tr("GNU General Public License version 2 or later")
#define ID_LICENSE_URL "https://www.gnu.org/licenses/old-licenses/gpl-2.0.html"
#ifdef _HARMATTAN
