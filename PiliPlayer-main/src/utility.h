...
public:
    ...
    Q_INVOKABLE QString Sign(const QVariantMap &args, const QString &suffix = QString(), const QVariantMap &sysArgs = QVariantMap()) const;
		Q_INVOKABLE QVariant WbiSign(const QVariantMap &args, const QString &imgKey, const QString &subKey) const;
		Q_INVOKABLE QString Av2Bv(const QString &av) const;
		Q_INVOKABLE QString Bv2Av(const QString &bv) const;
		...
		Q_INVOKABLE void DumpCookies();
		Q_INVOKABLE QString Csrf() const;
		Q_INVOKABLE QString SaveDataUrl(const QString &dataUrl) const;
		Q_INVOKABLE void SetBilibiliCookies(const QVariant &cookies);
